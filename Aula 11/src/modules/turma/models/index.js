...
class Turma{
    static async criar(nome, modalidade, dataInicio, dataTermino){
    ...
    static async editar(id, nome, modalidade, dataInicio, dataTermino){
